...
public class BuyMedicineDetailsActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPackageName=findViewById(R.id.textViewBMDdPackageName);
        tvTotalCost=findViewById(R.id.textViewBMDdTotalCost);
        edDetails=findViewById(R.id.editTextBMDdMultiline);
        edDetails.setKeyListener(null);
        btnBack=findViewById(R.id.buttonBMDdBack);
        btnAddToCart=findViewById(R.id.buttonBMDdAddToCart);
